...
We'll use a [pickled](https://en.wikipedia.org/wiki/Serialization#Pickle) version of the data, [training.p](hhttps://drive.google.com/open?id=0B1MAGYyd23tnWWdaSVVCZkQ2MjQ) and [valid.p](https://drive.google.com/open?id=0B1MAGYyd23tnWWdaSVVCZkQ2MjQ). 
